...
routes = [ login_bp, validate_jwt_token_bp, health_bp, user_bp, operation_bp, automated_scrap_operation_bp, kalibrr_bp, jobstreet_bp, linkedin_bp, indeed_bp, sock_bp]
